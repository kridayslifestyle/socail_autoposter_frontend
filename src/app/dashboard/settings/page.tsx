...
export default function SettingsPage() {
    ...
    const fetchBrand = async () => {
      try {
        const response = await fetch(
          "https://socailautoposterbackend.up.railway.app/auth/brands/me",
          {
            credentials: "include",
          },
        );
  ...
  const connectInstagram = () => {
    window.location.href =
      "https://socailautoposterbackend.up.railway.app/auth/meta/login";
  };
  ...
  const disconnect = async () => {
    ...
    try {
      const response = await fetch(
        `https://socailautoposterbackend.up.railway.app/brands/${brand.id}/disconnect`,
        {
          method: "POST",
          credentials: "include",
        },
